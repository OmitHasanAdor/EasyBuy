...
export default function NotFound() {
  return (
    <section className="relative flex min-h-[75vh] w-full items-center justify-center overflow-hidden bg-[#FBF8F1] px-6 py-20">
      ...
      {/* "404" */}
      <span className="pointer-events-none absolute select-none font-serif text-[220px] font-bold leading-none text-[#2B2420]/[0.04] sm:text-[320px]">
        404
      </span>
      ...
      >
        ...
        >
          <PackageSearch className="h-10 w-10" strokeWidth={1.6} />
        </motion.div>
        ...
        <p className="max-w-md text-sm leading-relaxed text-[#5B5145]">
          ...
          the product might no longer be available.
        </p>

        {/* one CTA only, no competing buttons */}
        <Link
          href="/"
